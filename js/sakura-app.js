...
$(function () {
  ...
  console.log('%c isMiao %c', 'background:#24272A; color:#ffffff', '', 'https://github.com/Jimi331492')
  console.log('%c Github %c', 'background:#24272A; color:#ffffff', '', 'https://github.com/Jimi331492')
})
